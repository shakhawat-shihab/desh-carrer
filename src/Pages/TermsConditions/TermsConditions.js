    ...
    <div className="container">
      <div className="row my-5">
        <div className="col-lg-8 col-md-10 col-12">
          <h1 className="fw-bold mb-3">Terms Condition</h1>
          <div className="mt-3">
            <p>
              Effective date: April 04, 2023.
              <br />
              <br />
              Bangla Puzzle Limited ("us", "we", or "our") operates the
              www.deshcareer.com website (the "Service"). This page informs you
              ...
              associated with that data. Our Privacy Policy for Desh Career is
              created.
            </p>
            <p>
              We use your data to provide and improve the Service. By using the
              Service, you agree to this policy's collection and use of
              ...
              <a href="https://www.deshcareer.com" className="web-link">
                www.deshcareer.com
              </a>
            </p>
          </div>
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Information Collection And Use</h4>
            <p>
          ...
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Types of Data Collected</h4>
          ...
          <div className="mt-4">
            <h5 className=" mb-3">Usage Data</h5>
            <p>
          ...
          <div className="mt-4">
            <h5 className=" mb-3">Tracking & Cookies Data</h5>
            <p>
          ...
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Examples of Cookies we use:</h4>
            <ul>
              <li>
          ...
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Use of Data</h4>
          ...
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Transfer Of Data</h4>
            <p>
          ...
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Disclosure Of Data</h4>
            <h5 className="fw-bold mb-3">Legal Requirements</h5>
            <p>
          ...
          <div className="mt-5">
            <h5 className="fw-bold mb-3">Security Of Data</h5>
            <p>
          ...
          <div className="mt-5">
            <h5 className="fw-bold mb-3">Links To Other Sites</h5>
            <p>
          ...
          <div className="mt-5">
            <h4 className="fw-bold mb-3">Changes To This Privacy Policy</h4>
            <p>
          ...
          <div className="mt-5">
            ...
            <p>
              ...
              contact us: contact.deshcareer@gmail.com
            </p>
          </div>
        </div>
      </div>
